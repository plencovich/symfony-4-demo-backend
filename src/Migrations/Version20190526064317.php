 ...
 */
final class Version20190526064317 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE services DROP FOREIGN KEY FK1_cat');
        $this->addSql('DROP INDEX FK1_cat ON services');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE services ADD CONSTRAINT FK1_cat FOREIGN KEY (categoryid) REFERENCES type_destinations (id)');
        $this->addSql('CREATE INDEX FK1_cat ON services (categoryid)');
